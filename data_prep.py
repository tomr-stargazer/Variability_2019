...
from stetson_2020 import threeband_stetson_pandas, j_chisq_red, h_chisq_red, k_chisq_red
...
q1_variables = list(set.union(set(qj_variables), qh_variables, qk_variables) - set(q2_variables))
